...
const GuideModal: React.FC<GuideModalProps> = ({ onClose, onDontShowAgain }) => {
  ...
  return (
    ...
    >
      ...
      >
        {/* 헤더 */}
        <div className="sticky top-0 bg-gradient-to-r from-purple-50 to-pink-50 p-4 sm:p-6 rounded-t-2xl border-b border-purple-100 flex items-center justify-between">
          <div className="flex-1 min-w-0">
            <h2 className="text-xl sm:text-2xl font-bold text-gray-800">철학자와 도란도란 ☕</h2>
            <p className="text-xs sm:text-sm text-gray-600 mt-1">앱 사용 가이드</p>
          </div>
          <button
            onClick={handleClose}
            className="p-2 rounded-full hover:bg-purple-100 active:bg-purple-200 transition-colors text-purple-600 flex-shrink-0 min-w-[44px] min-h-[44px] flex items-center justify-center ml-2"
          >
            <CloseIcon />
          </button>
        </div>
        ...
        <div className="p-4 sm:p-6 space-y-4 sm:space-y-6">
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="bg-gradient-to-r from-blue-50 to-cyan-50 rounded-xl p-3 sm:p-4 border-l-4 border-blue-400">
                <h4 className="font-semibold text-gray-800 mb-2 text-sm sm:text-base">1. 철학자와 질문 선택</h4>
              ...
              <div className="bg-gradient-to-r from-blue-50 to-cyan-50 rounded-xl p-3 sm:p-4 border-l-4 border-blue-400">
                <h4 className="font-semibold text-gray-800 mb-2 text-sm sm:text-base">2. 교과서 및 영상 보기</h4>
                <p className="text-gray-700 text-xs sm:text-sm">
              ...
              <div className="bg-gradient-to-r from-blue-50 to-cyan-50 rounded-xl p-3 sm:p-4 border-l-4 border-blue-400">
                <h4 className="font-semibold text-gray-800 mb-2 text-sm sm:text-base">3. 철학자 프로필 보기</h4>
                <p className="text-gray-700 text-xs sm:text-sm">
              ...
              <div className="bg-gradient-to-r from-blue-50 to-cyan-50 rounded-xl p-3 sm:p-4 border-l-4 border-blue-400">
                <h4 className="font-semibold text-gray-800 mb-2 text-sm sm:text-base">4. 철학자와 대화하기</h4>
                <p className="text-gray-700 text-xs sm:text-sm">
              ...
              <div className="bg-gradient-to-r from-blue-50 to-cyan-50 rounded-xl p-3 sm:p-4 border-l-4 border-blue-400">
                <h4 className="font-semibold text-gray-800 mb-2 text-sm sm:text-base">5. 대화 저장하기</h4>
                <p className="text-gray-700 text-xs sm:text-sm">
        ...
        {/* 하단 */}
        <div className="sticky bottom-0 bg-gradient-to-r from-purple-50 to-pink-50 p-3 sm:p-4 border-t border-purple-100 rounded-b-2xl flex flex-col sm:flex-row items-center justify-between gap-3">
          {/* Footer */}
          <div className="text-left flex-1 min-w-0">
            <p className="text-xs sm:text-sm mb-1 text-gray-700 font-medium">행복한 수학, 함께 만들어요! 😊</p>
          ...
          <button
            onClick={handleClose}
            className="w-full sm:w-auto px-6 py-2.5 sm:py-2 bg-gradient-to-r from-purple-500 to-pink-500 text-white font-medium rounded-xl hover:from-purple-600 hover:to-pink-600 active:from-purple-700 active:to-pink-700 transition-all shadow-md flex-shrink-0 min-h-[44px]"
          >
            시작하기
          </button>
        </div>
